...
public class Main {
    ...
    static FileScriptsManager fileScriptsManager = new FileScriptsManager();
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Command> commands = new ArrayList<>(Arrays.asList(
                ...
                new PrintFieldDescendingUnitOfMeasureCommand(consoleOutput),
                new ExecuteScriptCommand(consoleOutput, commandManager, consoleInput, fileScriptsManager)
        ));
